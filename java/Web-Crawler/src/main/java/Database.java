...
public class Database {
    ...
    public ObjectId insertDocument(String url, Optional<Integer> popularity, String body,String title,String p) {
        ObjectId newId = null;
        ...
        while (!isUniqueId) {
            ...
            if (existingDoc == null) {
                ...
                doc.append("p",p);// Inserting the body of the document
